...
function Window({ children }) {
  return (
    <div className="bg-[#FFFFFF] border-10 border-[#F6F6F6] rounded-3xl h-full w-full outline-[#F6F6F6] shadow-md">
      {children}
    </div>
  )
}
...
export default function RobotController() {
  ...
  return (
    <>
      <Header />
        <main
          className="bg-background h-[calc(100vh-4rem)] w-full p-16 grid grid-cols-[3fr_2fr] grid-rows-[3fr-2fr] gap-12"
        >
